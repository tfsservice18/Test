...
public class SignInUserTest {
    ...
    public void testSignInByUserId() throws ClientException, ApiException {
        ...
        String s = "{\"host\":\"lightapi.net\",\"service\":\"user\",\"action\":\"signInUser\",\"version\":\"0.1.0\",\"data\":{\"host\":\"example.org\",\"userIdEmail\":\"test\",\"password\":\"123456\"}}";
        try {
    ...
    public void testSignByEmail() throws ClientException, ApiException {
        ...
        final AtomicReference<ClientResponse> reference = new AtomicReference<>();
        String s = "{\"host\":\"lightapi.net\",\"service\":\"user\",\"action\":\"signInUser\",\"version\":\"0.1.0\",\"data\":{\"host\":\"example.org\",\"userId\":\"test\",\"email\":\"stevehu@gmail.com\",\"password\":\"123456\",\"passwordConfirm\":\"123456\"}}";
        try {
            ClientRequest request = new ClientRequest().setPath("/api/json").setMethod(Methods.POST);
            request.getRequestHeaders().put(Headers.CONTENT_TYPE, "application/json");
            request.getRequestHeaders().put(Headers.TRANSFER_ENCODING, "chunked");
