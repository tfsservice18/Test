...
public class UserEmailGetHandlerTest {
    ...
    static {
        ...
        try (Connection connection = ds.getConnection()) {
            ...
            InputStream in = UserEmailGetHandlerTest.class.getResourceAsStream(schemaResourceName);
    ...
    static final Logger logger = LoggerFactory.getLogger(UserEmailGetHandlerTest.class);
