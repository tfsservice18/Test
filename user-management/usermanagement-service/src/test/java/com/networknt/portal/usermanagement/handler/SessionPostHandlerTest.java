...
public class SessionPostHandlerTest {
    @ClassRule
    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(SessionPostHandlerTest.class);
    ...
    public void testSessionPostHandlerTest() throws ClientException, ApiException {
        ...
        try {
            ClientRequest request = new ClientRequest().setPath("/v1/session").setMethod(Methods.POST);
